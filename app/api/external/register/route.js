  ...
  try {
    ...
    if (existingUser) {
      ...
      if (!existingUser.emailVerified) {
        ...
        await resend.emails.send({
          ...
          subject: 'VCorp - Verify Your Email',
          html: generateVerificationEmail(firstName, magicLink),
        });
    ...
    const stripeCustomer = await stripe.customers.create({
      ...
      metadata: {
        ...
        registeredFrom: validRedirectUrl,
      },
    });
        ...
        ? [
            {
              ...
              tier: tier || null,
              enrolledAt: new Date(),
              status: 'pending', // Will be set to 'active' after onboarding
            },
          ]
        : [],
    });
    ...
    try {
      ...
      // Continue anyway - user is created, we'll return success
    }

    console.log('🔗 External registration - Magic Link:', magicLink);
 ...
 */
function generateVerificationEmail(firstName, magicLink) {
  return `
    <!DOCTYPE html>
    <html>
      <head>
